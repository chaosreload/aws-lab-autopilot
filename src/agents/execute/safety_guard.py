...
ALLOWED_SERVICES: frozenset[str] = frozenset(
    {
        ...
        "dsql",
        "dynamodb",
        # EC2 / ECS / ECR / EFS / EKS / ElastiCache
        "ec2",
        "ecr",
        "ecs",
        "efs",
        ...
        # Health
        "health",
        # IAM / Image Builder / Inspector / IoT
        "iam",
        "imagebuilder",
        "inspector2",
        "iot",
        ...
        # Personalize / Pinpoint / Pipes / Polly
        "personalize",
        "personalize-runtime",
        "pinpoint",
        "pipes",
        ...
        # QuickSight
        "quicksight",
        # RDS / Redshift / Rekognition / Resource Explorer
        "rds",
        "rds-data",
        "redshift",
        "redshift-data",
        ...
        "sagemaker-runtime",
        # Scheduler / Secrets Manager / Security Hub / SES
        "scheduler",
        "secretsmanager",
        "securityhub",
        "service-quotas",
        ...
        "sesv2",
        "shield",
        # SNS / SQS / SSM / Step Functions / STS
        "sns",
        "sqs",
        "ssm",
        "stepfunctions",
        "sts",
        # Textract / Transcribe / Transfer / Translate / Trusted Advisor
        "textract",
        "transcribe",
        "transfer",
        "translate",
        "trustedadvisor",
        # Verified Permissions / VPC Lattice
        "verifiedpermissions",
        "vpc-lattice",
        # WAF
        "waf-regional",
